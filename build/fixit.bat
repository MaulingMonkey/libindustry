...
auto_add  "../{industry,unit-tests,benchmarks}/**/*/"        # automatically add new directories
auto_add  "../{industry,unit-tests,benchmarks}/**/*.[ch]pp"  # automatically add new source files
...
vcproj    "win/benchmarks-vs2008.vcproj"  , :root => "../benchmarks"
