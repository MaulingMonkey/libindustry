...
#define INDUSTRY_IMPL_ENUM_RAW_FILTER( r, unused_data, i, e ) BOOST_PP_COMMA_IF(i) BOOST_PP_CAT(_,e)
...
class T {                                                          \
public:                                                            \
    enum _ { BOOST_PP_SEQ_FOR_EACH_I( INDUSTRY_IMPL_ENUM_RAW_FILTER, ~, values ) }; \
    _ value;                                                       \
private:                                                           \
